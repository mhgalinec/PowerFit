    ...
    public partial class PowerFitContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Type>().HasData(
                new Type { TypeId = 1, Name = "Kompaktna vježba", Description = "Vježbe kod kojih se koristi više skupina mišića."},
                new Type { TypeId = 2, Name = "Izolacijska vježba", Description = "Vježbe gdje se primarno koristi jedan mišić."},
                new Type { TypeId = 3, Name = "Statička vježba", Description = "Vježbe gdje nema pokreta u zglobovima i gdje se mišić drži u istom položaju."}
                );
            modelBuilder.Entity<Exercise>().HasData(
                new Exercise { ExerciseId = 1, ExerciseName = "Stražnji čučanj", EnglishExerciseName = "Back squat", Image = null,ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 2, ExerciseName = "Prednji čučanj", EnglishExerciseName = "Front squat", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 3, ExerciseName = "Iskorak", EnglishExerciseName = "Lunge", Image = null, Description = "", ExerciseTypeId = 1, InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 4, ExerciseName = "Zgib", EnglishExerciseName = "Pullup", Image = null, Description = "", ExerciseTypeId = 1, InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 5, ExerciseName = "Veslanje u natklonu", EnglishExerciseName = "Barbell row", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 6, ExerciseName = "Veslanje sa bučicom", EnglishExerciseName = "Dumbbell row", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 7, ExerciseName = "Konvencionalno mrtvo dizanje", EnglishExerciseName = "Conventional deadlift", ExerciseTypeId = 1, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 8, ExerciseName = "Sumo mrtvo dizanje", EnglishExerciseName = "Sumo deadlift", Image = null,ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 9, ExerciseName = "Rumunjsko mrtvo dizanje", EnglishExerciseName = "Romanian deadlift", ExerciseTypeId = 1, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 10, ExerciseName = "Triceps ekstenzija iznad glave", EnglishExerciseName = "Overhead triceps extension", ExerciseTypeId = 2, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 11, ExerciseName = "Potisak s čela na ravnoj klupi", EnglishExerciseName = "Skullcrusher", ExerciseTypeId = 2, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 12, ExerciseName = "Paralelno prodapadnje", EnglishExerciseName = "Dips", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 13, ExerciseName = "Stojeći pregib sa šipkom", EnglishExerciseName = "Barbell curl", Image = null, ExerciseTypeId = 2, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 14, ExerciseName = "Pregib s bučicama", EnglishExerciseName = "Dumbbell curl", Image = null, ExerciseTypeId = 2, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 15, ExerciseName = "Pregib bučicama sa neutralnim hvatom", EnglishExerciseName = "Hammer curl", ExerciseTypeId = 2, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 16, ExerciseName = "Okomito veslanje", EnglishExerciseName = "Upright row", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 17, ExerciseName = "Potisak iznad glave", EnglishExerciseName = "Overhead press", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 18, ExerciseName = "Potisak iza glave", EnglishExerciseName = "Behind the neck press", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 19, ExerciseName = "Lateralno podizanje", EnglishExerciseName = "Lateral raise", Image = null, ExerciseTypeId = 2, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 20, ExerciseName = "Potisak sa ravne klupe", EnglishExerciseName = "Flat bench press", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 21, ExerciseName = "Potisak sa kose klupe", EnglishExerciseName = "Incline bench press", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 22, ExerciseName = "Razvlačenje bučicama na ravnoj klupi", EnglishExerciseName = "Flat dumbbell flys", ExerciseTypeId = 2, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 23, ExerciseName = "Plank", EnglishExerciseName = "Plank", Image = null, Description = "", ExerciseTypeId = 3, InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 24, ExerciseName = "Bočni plank", EnglishExerciseName = "Side plank", Image = null, ExerciseTypeId = 3, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 25, ExerciseName = "V-podizanja", EnglishExerciseName = "V-situps", Image = null, ExerciseTypeId = 2, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 30, ExerciseName = "Fleksija vrata", EnglishExerciseName = "Neck curl", Image = null, ExerciseTypeId = 2, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 31, ExerciseName = "Ekstenzija vrata", EnglishExerciseName = "Neck extension", ExerciseTypeId = 2, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 32, ExerciseName = "Pregib zapešća", EnglishExerciseName = "Wrist curl", ExerciseTypeId = 2, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 33, ExerciseName = "Obrnuti pregib zapešća", EnglishExerciseName = "Reverse wrist curl", Image = null, ExerciseTypeId = 2, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 34, ExerciseName = "Pronacija zapešća", EnglishExerciseName = "Pronation", Image = null, Description = "", ExerciseTypeId = 2, InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 35, ExerciseName = "Supinacija zapešća", EnglishExerciseName = "Supination", Image = null, Description = "", ExerciseTypeId = 2, InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 36, ExerciseName = "Stojeće podizanje listova", EnglishExerciseName = "Standing calf raise", Image = null, ExerciseTypeId = 2, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 37, ExerciseName = "Sjedeće podizanje listova", EnglishExerciseName = "Seated calf raise", Image = null, ExerciseTypeId = 2, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 38, ExerciseName = "Podizanje listova na nožnoj preši", EnglishExerciseName = "Leg press calf raise", ExerciseTypeId = 2, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 39, ExerciseName = "Farmerov hod", EnglishExerciseName = "Farmers walk", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 40, ExerciseName = "Log nabačaj i potisak", EnglishExerciseName = "Log clean and press", ExerciseTypeId = 1, Image = null, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 41, ExerciseName = "Yoke hod", EnglishExerciseName = "Yoke walk", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 42, ExerciseName = "Nabačaj i potisak",EnglishExerciseName="Clean and press", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 43, ExerciseName = "Nabačaj i izbačaj",EnglishExerciseName="Clean and jerk", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 44, ExerciseName = "Tabata",EnglishExerciseName="Tabata", Image = null, Description = "", ExerciseTypeId = 1, InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 45, ExerciseName = "Sprava za veslanje",EnglishExerciseName="Rowing machine", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 46, ExerciseName = "Stacionaran bicikl",EnglishExerciseName="Stationary bike", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 47, ExerciseName = "Trčanje",EnglishExerciseName="Running", Image = null, Description = "", ExerciseTypeId = 1, InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 48, ExerciseName = "Eliptični trenažer",EnglishExerciseName="Eliptical trainer", Image = null, ExerciseTypeId = 1, Description = "", InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 49, ExerciseName = "Trzaj",EnglishExerciseName="Snatch", Image = null, Description = "", ExerciseTypeId = 1, InsertDate = DateTime.Now, IsDeleted = false },
                new Exercise { ExerciseId = 50, ExerciseName = "Z potisak",EnglishExerciseName="Z press", Image = null, Description = "", ExerciseTypeId = 1, InsertDate = DateTime.Now, IsDeleted = false }
            ...
            modelBuilder.Entity<ExerciseCategoryRelationship>().HasData(
                ...
                new ExerciseCategoryRelationship { ExerciseCategoryRelationshipId = 12, ExerciseId = 5, SecondaryCategoryId = 4 },
                //new ExerciseCategoryRelationship { ExerciseCategoryRelationshipId = 14, ExerciseId = 5, SecondaryCategoryId = 6 },
                new ExerciseCategoryRelationship { ExerciseCategoryRelationshipId = 13, ExerciseId = 6, SecondaryCategoryId = 4 },
                ...
                new ExerciseCategoryRelationship { ExerciseCategoryRelationshipId = 14, ExerciseId = 7, SecondaryCategoryId = 13 },
                ...
                new ExerciseCategoryRelationship { ExerciseCategoryRelationshipId =